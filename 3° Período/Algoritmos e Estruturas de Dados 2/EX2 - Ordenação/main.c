...
void imprimirTabela(double tempo_ord, int t_ord, int comp, double tempo_inv,
  ...
  printf("+---------------------------------------------------------------------------------------------+\n");
  printf("| Entrada                             | Tempo (s)      |  Nro comparacoes   |   Nro Trocas    |\n");
  printf("+---------------------------------------------------------------------------------------------+\n");
  printf("| 10000 numeros inteiros ordenados    | %-15f| %-14d     |%-13d    |\n", tempo_ord,comp, t_ord);
  printf("| 10000 numeros inteiros decrescentes | %-15f| %-14d     |%-13d    |\n", tempo_inv, comp2, t_inv);
  printf("| 10000 numeros inteiros aleatorios   | %-15f| %-14d     |%-13d    |\n", tempo_ale, comp3,  t_ale);
  printf("+---------------------------------------------------------------------------------------------+\n");
}
...
int main() {
  ...
  imprimirTabela(tempo_ord_bub, t_ord_bub, c_ord_bub, tempo_inv_bub, t_inv_bub,     c_inv_bub, tempo_ale_bub, t_ale_bub, c_ale_bub, "Bubble Sort");
  ...
  imprimirTabela(tempo_ord_sel, t_ord_sel, c_ord_sel, tempo_inv_sel, t_inv_sel,     c_inv_sel, tempo_ale_sel, t_ale_sel, c_ale_sel, "Selection Sort");
  ...
  c_inv_ins, tempo_ale_ins, t_ale_ins, c_ale_ins, "Insertion Sort");
